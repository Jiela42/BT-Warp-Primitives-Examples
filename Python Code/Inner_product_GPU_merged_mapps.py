...
sdfg.add_array('A', shape=[N], dtype=dace.float64, storage=StorageType.GPU_Global)
sdfg.add_array('B', shape=[N], dtype=dace.float64, storage=StorageType.GPU_Global)
sdfg.add_array('temp1', shape=[N], dtype=dace.float64, transient=True, storage=StorageType.GPU_Global)
sdfg.add_array('__return', shape=[1], dtype=dace.float64, storage=StorageType.GPU_Global)
